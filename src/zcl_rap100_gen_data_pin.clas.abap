CLASS zcl_rap100_gen_data_pin DEFINITION
PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_pin IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE 'PIN',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap100_atravpin.
*    DELETE FROM zrap100_dtravpin.

    "insert travel demo data
    INSERT zrap100_atravpin  FROM (
        SELECT
    ...
    COMMIT WORK.
    out->write( |[RAP100] Demo data generated for table ZRAP100_ATRAV{ group_id }. | ) ##NO_TEXT.
  ENDMETHOD.
ENDCLASS.
