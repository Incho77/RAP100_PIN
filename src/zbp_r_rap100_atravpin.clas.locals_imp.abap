CLASS lhc_zr_rap100_atravpin DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
...
CLASS lhc_zr_rap100_atravpin IMPLEMENTATION.
  ...
  METHOD earlynumbering_create.
    ...
    DATA:
      entity           TYPE STRUCTURE FOR CREATE zr_rap100_atravpin,
    ...
    ELSE.
      ...
      SELECT SINGLE FROM zrap100_atravpin FIELDS MAX( travel_id ) AS travelID INTO @travel_id_max.
      "Get max travel ID from draft table
      SELECT SINGLE FROM zrap100_atravpid FIELDS MAX( travelid ) INTO @DATA(max_travelid_draft).
  ...
  METHOD setStatusToOpen.
    ...
    READ ENTITIES OF zr_rap100_atravpin IN LOCAL MODE
     ENTITY Travel
    ...
    MODIFY ENTITIES OF zr_rap100_atravpin IN LOCAL MODE
      ENTITY Travel
        UPDATE SET FIELDS
...
**************************************************************************
  METHOD deductDiscount.
    ...
    DATA travels_for_update TYPE TABLE FOR UPDATE zr_rap100_atravpin.
...
**************************************************************************
  METHOD copyTravel.
    DATA:
      travels TYPE TABLE FOR CREATE zr_rap100_atravpin\\travel.
